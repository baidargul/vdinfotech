...
function Icon({ name, className = "" }: { name: IconName; className?: string }) {
  const paths: Record<IconName, ReactNode> = {
    ...
    design: <><path d="M12 3a9 9 0 1 0 0 18h1.3a2.2 2.2 0 0 0 0-4.4h-1.2a1.8 1.8 0 0 1 0-3.6H15a6 6 0 0 0 0-12Z"/><circle cx="7.5" cy="10" r=".7"/><circle cx="9" cy="6.8" r=".7"/><circle cx="13" cy="6" r=".7"/></>,
...
const services = [
  ...
  { icon: "design" as const, number: "03", title: "UI/UX Design", text: "Research-led interfaces that turn complex workflows into clear, elegant digital experiences." },
...
const projects = [
  { type: "Fintech platform", title: "Orbit Finance", result: "2.4× faster onboarding", className: "project-orbit" },
  { type: "Health technology", title: "CareSync", result: "60% fewer admin tasks", className: "project-care" },
  { type: "Commerce ecosystem", title: "Northstar", result: "+38% conversion", className: "project-north" },
];
...
const faqs = [
  ...
  { question: "Can you improve an existing product?", answer: "Yes. We can audit your existing user experience and codebase, identify the highest-impact improvements, and deliver them in manageable phases without disrupting your current users." },
            ...
            {projects.map((project, index) => (
              <article className={`project-card ${project.className}`} key={project.title}>
                <div className="project-mockup" aria-hidden="true">
                  ...
                  <div className="mock-card-a" /><div className="mock-card-b" />
                </div>
